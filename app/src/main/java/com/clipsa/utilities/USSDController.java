...
public class USSDController implements USSDInterface, USSDApi {
    ...
    protected com.romellfudi.ussdlibrary.USSDController.CallbackInvoke callbackInvoke;

    protected com.romellfudi.ussdlibrary.USSDController.CallbackMessage callbackMessage;
     ...
     */
    public void callUSSDInvoke(String ussdPhoneNumber, HashMap<String, HashSet<String>> map, com.romellfudi.ussdlibrary.USSDController.CallbackInvoke callbackInvoke) {
     ...
     * @param callbackInvoke  a callback object from return answer
     */
    public void callUSSDOverlayInvoke(String ussdPhoneNumber, HashMap<String, HashSet<String>> map, com.romellfudi.ussdlibrary.USSDController.CallbackInvoke callbackInvoke) {
    ...
    public void callUSSDInvoke(String ussdPhoneNumber, int simSlot, HashMap<String, HashSet<String>> map, com.romellfudi.ussdlibrary.USSDController.CallbackInvoke callbackInvoke) {
     ...
     */
    @SuppressLint("MissingPermission")
    public void callUSSDOverlayInvoke(String ussdPhoneNumber, int simSlot, HashMap<String, HashSet<String>> map, com.romellfudi.ussdlibrary.USSDController.CallbackInvoke callbackInvoke) {
        this.callbackInvoke = callbackInvoke;
        this.map = map;
    ...
    public void send(String text, com.romellfudi.ussdlibrary.USSDController.CallbackMessage callbackMessage) {
    ...
    private static void openSettingsAccessibility(final Activity activity) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(activity, R.style.AppAlertDialog);
        ...
        alertDialogBuilder.setNeutralButton("ok", (dialog, id) -> activity.startActivityForResult(new Intent(Settings.ACTION_ACCESSIBILITY_SETTINGS), 1));
