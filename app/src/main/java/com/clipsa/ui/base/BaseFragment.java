...
import com.cowtribe.cowtribeapps.data.AppDataManager;
import com.cowtribe.cowtribeapps.utilities.AppConstants;
import com.cowtribe.cowtribeapps.utilities.CommonUtils;
import com.cowtribe.cowtribeapps.utilities.OnFragmentInteractionListener;
...
public abstract class BaseFragment extends Fragment implements BaseContract.FragmentView {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            fragmentInteractionListener.showDrawerMenu( R.id.menu_home, R.id.menu_performance, R.id.menu_my_communities, R.id.bottom_nav_finances,
                   R.id.bottom_nav_orders, R.id.bottom_nav_farmers);
        }
